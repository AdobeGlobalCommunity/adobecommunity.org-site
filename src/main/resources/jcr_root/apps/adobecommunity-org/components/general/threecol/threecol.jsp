...
<div class="row text-center justify-content-center">
	<div class="col-md-4 px-0">
		<div class="p-4 mr-sm-0 mr-md-2 background--white h-100">
			<img src="${properties.image1}" class="mx-auto my-4 d-block" alt="${sling:encode(properties.header1,'HTML_ATTR')}">
			<h4>
	...
	<c:if test="${not empty properties.header3}">
		<div class="col-md-4 px-0">
			<div class="p-4 background--white h-100">
				<img src="${properties.image3}" class="mx-auto my-4 d-block" alt="${sling:encode(properties.header3,'HTML_ATTR')}">
				<h4>
